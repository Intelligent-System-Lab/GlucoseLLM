...
accelerate launch --mixed_precision bf16 --num_processes $num_process --main_process_port $master_port run_glucose.py \
  ...
  --model_id 559_BBM_60MINS_Deepseek \
  --model $model_name \
  --data Glucose \
  --features S \
  --separate_test yes \
...
accelerate launch --mixed_precision bf16 --num_processes $num_process --main_process_port $master_port run_glucose.py \
  ...
  --model_id 563_BBM_60MINS_Deepseek \
  --model $model_name \
  --data Glucose \
  --features S \
  --separate_test yes \
 ...
 accelerate launch --mixed_precision bf16 --num_processes $num_process --main_process_port $master_port run_glucose.py \
  ...
  --model_id 570_BBM_60MINS_Deepseek \
  --model $model_name \
  --data Glucose \
  --features S \
  --separate_test yes \
 ...
 accelerate launch --mixed_precision bf16 --num_processes $num_process --main_process_port $master_port run_glucose.py \
  ...
  --model_id 575_BBM_60MINS_Deepseek \
  --model $model_name \
  --data Glucose \
  --features S \
  --separate_test yes \
 ...
 accelerate launch --mixed_precision bf16 --num_processes $num_process --main_process_port $master_port run_glucose.py \
  ...
  --model_id 588_BBM_60MINS_Deepseek \
  --model $model_name \
  --data Glucose \
  --features S \
  --separate_test yes \
